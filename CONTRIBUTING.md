...
Welcome to `bripy` contributor's guide.
...
If you experience bugs or general issues with `bripy`, please have a look
...
You can help improve `bripy` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`bripy` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `bripy`'s files. While this mechanism can
...
```
conda create -n bripy python=3 six virtualenv pytest pytest-cov
conda activate bripy
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/bripy.git
   cd bripy
   ```
...
5. Install [pre-commit]:
   ...
   `bripy` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/bripy
[issue tracker]: https://github.com/<USERNAME>/bripy/issues
