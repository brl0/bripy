...
def get_en_stopwords() -> set[str]:
    ...
    u = "https://raw.githubusercontent.com/6/stopwords-json/master/dist/en.json"
...
def get_vocab(docs):
    ...
    for doc in docs:  # Looping, statefulness of Counter seems non-functional
        vocab.update(get_tokens(doc))  # Counter update accumulates without return
    print("vocab size: ", len(vocab))
    return vocab


def get_sumy(sentences_count: int = 10, body: str = "", url: str | None = None) -> str:
